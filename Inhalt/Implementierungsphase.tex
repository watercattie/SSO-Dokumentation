...
Es wurde auf weitere Spezifizierungen der Sicherheit verzichtet, da das Passport Paket automatisiert alle wichtigen Standards aus dem Internet Engineering Task Force\footnote{vgl \cite{OAuth2}} umsetzt. Ein Ausschnitt der genutzten Klassen befindet sich im  \Anhang{app:passport-controllers}.
