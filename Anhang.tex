...
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{timy-mockup-login.png}{0.9}
...
Der folgende Screenshot beschreibt die Loginseite des \acs{SSO}.
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{wy-connect-login.png}{0.9}
...
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{wy-connect-screen.png}{0.9}
...
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{timy-login-anwendung.png}{0.9}
