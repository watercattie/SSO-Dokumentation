...
\ihead{\large{{\kurzertitel}}\\[2ex] \textit{\headmark}}
\ohead{\pagemark}
\chead{}
...
% Fußzeile
\ifoot{\autorName}
\ofoot{\\ \includegraphics[scale=0.25]{\betriebLogo}}
...
% Tabellenfärbung:
\definecolor{heading}{RGB}{163 178 0}
\definecolor{odd}{rgb}{0.9,0.9,0.9}

% Überschriftenfärbung
\definecolor{wyc-green}{RGB}{163 178 0}
\definecolor{wyc-grey}{RGB}{51 51 51}
\usepackage{xcolor}
\usepackage{sectsty}
\sectionfont{\color{wyc-green}}
\subsectionfont{\color{wyc-grey}}  % sets colour of chapters
